'''Модуль с одной функцией window
Эта функция отвечают за всё выводимое на экрна меню программы
А также, вызывает другие функции, нужные для работы программы
Этот модуль можно считать головным
Функция в отдельном модуле, из-за своего большого размера другим функционалом
В отличии от функций в модуле work_file.py, window работает только с выводом информации и логикой программы
'''
